...
// PieceCount returns the number of pieces of the requested color and type.
// It uses the board's native bitboards and does not allocate a SquareMap.
func (b *Board) PieceCount(piece Piece) int {
	return bits.OnesCount64(uint64(b.bbForPiece(piece)))
}
